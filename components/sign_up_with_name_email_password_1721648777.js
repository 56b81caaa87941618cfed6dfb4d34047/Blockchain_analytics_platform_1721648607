Vue.component('sign_up_with_name_email_password_1721648777', 
    { template: `
    ...
    <div class="text-center">
        ...
        <h3 class="text-gray-800 text-xl font-bold">
            Create a New Account for Blockchain Analysis
        </h3>
        </div>
        <p class="text-center">Already have an account? Sign in here
        <a href="javascript:void(0)" class="text-center font-medium text-indigo-600 hover:text-indigo-500">Log in to Analyze Blockchain Data</a>
        </p>
        </div>
    </div>
  <div class="bg-white text-center shrink shadow py-6 sm:p-6 sm:rounded-lg">
    <form onSubmit="event.preventDefault()" class="space-y-5">
      <div>
        <label class="font-medium">Enter your full name</label>
      ...
      <button class="text-xs px-4 py-2 pr-10 text-white font-medium bg-indigo-600 hover:bg-indigo-500 active:bg-indigo-600 rounded-lg duration-150">
        <h6 class="text-gray-800 text-xs text-white font-medium">Add Account</h6>
     </button>
     </span>
