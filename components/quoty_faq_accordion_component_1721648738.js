...
Vue.component("quoty_faq_accordion_component_1721648738", {
    template: `
    ...
    data() {
        return {
            terms: [
                { title: "What is the blockchain analysis app used for?", description: "Our app allows you to easily analyze new data and information on various blockchain networks. It provides insights into transactions, smart contracts, token activity, and more.", expanded: false },
                { title: "What blockchains does the app support?", description: "Currently, we support analysis for Ethereum, Bitcoin, Polkadot, and several other major blockchain platforms. We are constantly working to add support for more networks.", expanded: false },
                { title: "How often is the app data updated?", description: "Our app ingests and analyzes new blockchain data in real-time as it gets added to the respective networks. This ensures you always have access to the latest information.", expanded: false },
                { title: "Is there a free trial or demo available?", description: "Yes, we offer a free 14-day trial so you can test out the full capabilities of our blockchain analysis app before purchasing a subscription. Sign up on our website to get started.", expanded: false },
            ],
        };
    },
    methods: {
