...
*/
Vue.component("simple_footer_component_1721648610", {
    template: `
                ...
                <div id="footer-content" class="text-center">
                    <div class="flex">
                        <a id="footer-logo-link" href="#" class="flex-1 flex items-center justify-center mb-5 text-2xl font-semibold text-gray-900 dark:text-white">
                            ...
                            DecryptEdge: Blockchain Analytics Platform
                        </a>
                    </div>
                </div>
                <div class="flex">
                    <div id="footer-text" class="flex-1 block text-sm text-center text-gray-500 dark:text-gray-400">
                        Stay ahead of the curve with DecryptEdge - the leading platform for real-time blockchain data analysis and insights. Explore new opportunities and make informed decisions with our cutting-edge analytics tools.
                    </div>
                </div>
            </div>
        </footer> 
